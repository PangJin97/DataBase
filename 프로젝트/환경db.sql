...
CREATE TABLE TEST1 (
	TEST_NUM INT CONSTAINET TEST1_PK PRIMARY KEY,
	TEST_NAME VARCHAR(50) CONSTRAINT  NOT NULL
);


INSERT INTO TEST1 VALUES (1, "AAA");
# PK 중복 -> TEST1_PK ERROR      S01CR111는 PK 제약조건의 이름